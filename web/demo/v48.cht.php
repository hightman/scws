...
if (!isset($_REQUEST['mydata']) || empty($_REQUEST['mydata']))
	$mydata = file_get_contents('sample_cht.utf8.txt');	
else
{
...
<h3>
  ...
  <font color=blue>第4版(UTF8繁体)</font> - 在线演示 (by hightman)
</h3>  
基本功能: 根据词频词典较为智能的中文分词，支持规则识别人名、地区等。（<a href="v4.php">GBK点这里</a> <a href="v48.php">UTF-8</a>）<br />
